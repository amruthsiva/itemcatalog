...
candy2 = Candy(user_id=1, name="Polo",
                     description="Birthday Pack", price="$257",course = "Appetizer", candyshop=candyshop2)
...
candy1 = Candy(user_id=1, name="Reese's Peanut Butter Cups", description="Birthday Pack",
...
candy3 = Candy(user_id=1, name="Twix",
                     description="Birthday Pack", price="$40.50",course = "Entree",candyshop=candyshop1)
